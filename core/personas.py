...
PROFESSIONAL = Persona(
    text=(
        ...
        "EXCEPTION — product names: product and model names are proper nouns. Always write them exactly as they appear in [Product Reference] or [Internal Knowledge], in English letters (e.g. StarForge X1). NEVER translate or transliterate a product name into Chinese.\n\n"
